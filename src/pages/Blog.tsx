...
const Blog = () => {
  ...
  return (
    <PageLayout>
      <SEO 
        title="Bright Futures Foundation - News and insights about our mission" 
        description="Stay updated with the latest news and insights about children's welfare and community development from Bright Futures Foundation."
      ...
      <div className="w-full pt-24 pb-12 bg-gradient-to-b from-black to-gray-900 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Foundation News &amp; Insights</h1>
            <p className="text-xl text-gray-300 mb-6">
              The latest updates and stories from our work with children and communities in Uganda
            </p>
          </div>
        </div>
      </div>
